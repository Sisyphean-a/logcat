...
const palettes: Record<ThemeName, ThemePalette> = {
  dark: {
    ...
    vars: {
      ...
      "--info": "#70b8ff", "--warn": "#ffca16", "--error": "#ec5d5e", "--brand-border": "rgba(76, 204, 230, 0.32)",
      "--brand-bg": "rgba(0, 162, 199, 0.18)", "--brand-fg": "#4ccce6", "--shadow-dialog": "0 24px 60px rgba(0, 0, 0, 0.45)",
  ...
  light: {
    ...
    vars: {
      ...
      "--brand-border": "rgba(13, 116, 206, 0.24)", "--brand-bg": "rgba(13, 116, 206, 0.1)", "--brand-fg": "#0d74ce",
  ...
  "solarized-light": {
    ...
    vars: {
      ...
      "--brand-border": "rgba(38, 139, 210, 0.24)", "--brand-bg": "rgba(38, 139, 210, 0.12)", "--brand-fg": "#268bd2",
